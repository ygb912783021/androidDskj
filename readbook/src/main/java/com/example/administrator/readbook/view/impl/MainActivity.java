...
import com.example.administrator.readbook.presenter.impl.MainPresenterImpl;
...
import com.example.administrator.readbook.view.adapter.BookShelfAdapter;
import com.example.administrator.readbook.view.popupwindow.DownloadListPop;
import com.example.administrator.readbook.widget.refreshview.OnRefreshWithProgressListener;
...
public class MainActivity extends MBaseActivity<IMainPresenter> implements IMainView {
    ...
    protected void bindView() {
        ...
        rfRvShelf =  findViewById(R.id.rf_rv_shelf_34);
