...
import com.example.administrator.readbook.bean.ReadBookContentBean;
...
import com.example.administrator.readbook.presenter.IBookReadPresenter;
import com.example.administrator.readbook.utils.PremissionCheck;
import com.example.administrator.readbook.view.IBookReadView;
            ...
            if (null != bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex).getBookContentBean() && null != bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex).getBookContentBean().getDurCapterContent()) {
                ...
                Observable.create(new ObservableOnSubscribe<ReadBookContentBean>() {
                    ...
                    public void subscribe(ObservableEmitter<ReadBookContentBean> e) throws Exception {
                        List<BookContentBean> tempList = DbHelper.getInstance(mView.getContext()).getmDaoSession().getBookContentBeanDao().queryBuilder().where(BookContentBeanDao.Properties.DurChapterUrl.eq(bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex).getDurChapterUrl())).build().list();
                                    ...
                                    WebBookModelImpl.getInstance().getBookContent(bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex).getDurChapterUrl(), chapterIndex, bookShelf.getTag()).map(new Function<BookContentBean, BookContentBean>() {
                                        ...
                                        public BookContentBean apply(BookContentBean bookContentBean) throws Exception {
                                            if (bookContentBean.getRight()) {
                                                DbHelper.getInstance(mView.getContext()).getmDaoSession().getBookContentBeanDao().insertOrReplace(bookContentBean);
                                                bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex).setHasCache(true);
                                                DbHelper.getInstance(mView.getContext()).getmDaoSession().getChapterListBeanDao().update(bookShelf.getBookInfoBean().getChapterlist().get(chapterIndex));
                                            }
        ...
        if (bookShelf != null) {
            Observable.create(new ObservableOnSubscribe<BookShelfBean>() {
                ...
                public void subscribe(ObservableEmitter<BookShelfBean> e) throws Exception {
                    ...
                    DbHelper.getInstance(mView.getContext()).getmDaoSession().getBookShelfBeanDao().insertOrReplace(bookShelf);
                    e.onNext(bookShelf);
                    e.onComplete();
                }
            }).subscribeOn(Schedulers.newThread())
    ...
    private void checkInShelf() {
        Observable.create(new ObservableOnSubscribe<Boolean>() {
            ...
            public void subscribe(ObservableEmitter<Boolean> e) throws Exception {
                List<BookShelfBean> temp = DbHelper.getInstance(mView.getContext()).getmDaoSession().getBookShelfBeanDao().queryBuilder().where(BookShelfBeanDao.Properties.NoteUrl.eq(bookShelf.getNoteUrl())).build().list();
    ...
    public void addToShelf(final OnAddListner addListner) {
        if (bookShelf != null) {
            Observable.create(new ObservableOnSubscribe<Boolean>() {
                @Override
                public void subscribe(ObservableEmitter<Boolean> e) throws Exception {
                    DbHelper.getInstance(mView.getContext()).getmDaoSession().getChapterListBeanDao().insertOrReplaceInTx(bookShelf.getBookInfoBean().getChapterlist());
                    DbHelper.getInstance(mView.getContext()).getmDaoSession().getBookInfoBeanDao().insertOrReplace(bookShelf.getBookInfoBean());
