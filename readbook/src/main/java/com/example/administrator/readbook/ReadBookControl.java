...
public class ReadBookControl {
    ...
    public static ReadBookControl getInstance(Context context){
    ...
    private ReadBookControl(Context context){
        if(null == textKind){
            ...
            temp1.put("textExtra", DensityUtil.dp2px(context,6.5f));
            textKind.add(temp1);

            Map<String,Integer> temp2 = new HashMap<>();
            temp2.put("textSize", 16);
            temp2.put("textExtra", DensityUtil.dp2px(context,8));
            textKind.add(temp2);

            Map<String,Integer> temp3 = new HashMap<>();
            temp3.put("textSize", 17);
            temp3.put("textExtra", DensityUtil.dp2px(context,9));
            textKind.add(temp3);

            Map<String,Integer> temp4 = new HashMap<>();
            temp4.put("textSize", 20);
            temp4.put("textExtra", DensityUtil.dp2px(context,11));
            textKind.add(temp4);

            Map<String,Integer> temp5 = new HashMap<>();
            temp5.put("textSize", 22);
            temp5.put("textExtra", DensityUtil.dp2px(context,13));
            textKind.add(temp5);
        }
        ...
        preference = context.getSharedPreferences("CONFIG", 0);
