...
public class EBookDetailsActivity extends BaseActivity implements IBookDetailsView {
    /**
     * 书的图片
     */
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        requestActionBarStyle(true, "电子书详情", "购买");
        ...
        personAdapter.setOnCallBackData(new FuckYouAdapter.OnCallBackData() {
            ...
            public void convertView(BaseViewHolder helper, Object item) {
                ...
                if(is_borrow==0){
                    ...
                    GlideUtils.loadCircleImage(EBookDetailsActivity.this, bean.getAvatar(), photo);
    ...
    private void initEvalRecycle() {
        ...
        evalAdapter.setOnCallBackData(new FuckYouAdapter.OnCallBackData() {
            ...
            public void convertView(final BaseViewHolder helper, Object item) {
                ...
                GlideUtils.loadCircleImage(EBookDetailsActivity.this, bean.getAvatar(), avatar);
            ...
            public void convertView(final BaseViewHolder helper, Object item) {
                ...
                helper.getView(R.id.item_book_details_friend_msg).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(EBookDetailsActivity.this, EvalFriendActivity.class);
                            ...
                            public void onClick(DialogInterface d, int which) {
                                if (which == 0) {
                                    if (bookCaseList.size()>0){
                                        Intent intent = new Intent();
                                        intent.putExtra("isbn", bookIsbn);
                                        intent.setClass(EBookDetailsActivity.this, BorrowBookActivity.class);
        ...
        dialog = new AlertDialog.Builder(this)
                ...
                .setSingleChoiceItems(share, 0,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface d, int which) {
                                Intent intent = new Intent();
                                intent.setClass(EBookDetailsActivity.this, ShareBookActivity.class);
