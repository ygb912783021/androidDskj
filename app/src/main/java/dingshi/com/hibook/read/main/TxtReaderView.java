package dingshi.com.hibook.read.main;
...
import dingshi.com.hibook.read.interfaces.IReaderViewDrawer;
import dingshi.com.hibook.read.interfaces.ITextSelectListener;
import dingshi.com.hibook.read.interfaces.ITxtTask;
import dingshi.com.hibook.read.tasks.DrawPrepareTask;
import dingshi.com.hibook.read.tasks.TxtConfigInitTask;
import dingshi.com.hibook.read.tasks.TxtPageLoadTask;
    ...
    private void tryFetchFirstPage() {
        ...
        if (firstPage != null && firstPage.HasData()) {
            if (firstPage.getLineNum() < lineNum) {
                ...
                ITxtTask task = (ITxtTask) new DrawPrepareTask();
