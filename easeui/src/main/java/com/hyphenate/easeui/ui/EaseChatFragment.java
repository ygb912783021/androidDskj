...
//        messageList.setAvatarShape(1);
    ...
    protected void setUpView() {
        ...
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            ...
            titleBar.setRightImageResource(R.drawable.ease_search_delete);
        } else {
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onUserAgree(String type, String order, String isbn, String book, boolean isReceive, String toUserId) {
                if (chatFragmentHelper != null) {
                    chatFragmentHelper.onUserAgree(type, order, isbn, book, isReceive, toUserId);
                }
            }
            ...
            public void onUSerUnagree(String type, String order, String isbn, String book, boolean isReceive, String toUserId) {
                if (chatFragmentHelper != null) {
                    chatFragmentHelper.onUserUnagree(type, order, isbn, book, isReceive, toUserId);
                }
            }
    ...
    public interface EaseChatFragmentHelper {
        ...
        void onUserAgree(String type, String order, String isbn, String book, boolean isReceive, String toUserId);

        void onUserUnagree(String type, String order, String isbn, String book, boolean isReceive, String toUserId);
