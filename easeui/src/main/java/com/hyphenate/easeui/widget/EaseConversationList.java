...
public class EaseConversationList extends ListView {
    ...
    public void init(List<EMConversation> conversationList, EaseConversationAdapter.EaseAgreeListener agreeListener) {
        this.init(conversationList, null, agreeListener);
    }

    public void init(List<EMConversation> conversationList, EaseConversationListHelper helper, final EaseConversationAdapter.EaseAgreeListener agreeListener) {
        ...
        adapter.setEaseAgreeListener(new EaseConversationAdapter.EaseAgreeListener() {
            @Override
            public void agree() {
                agreeListener.agree();
            }
