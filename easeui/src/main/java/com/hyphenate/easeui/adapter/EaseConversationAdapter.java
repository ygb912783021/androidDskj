...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
         ...
         *  获取扩展字段
         */
        EMLog.e("conversation", conversation.getExtField());
...
//                            username = user.getNick();
    ...
    public EaseAgreeListener easeAgreeListener;

    public void setEaseAgreeListener(EaseAgreeListener easeAgreeListener) {
        this.easeAgreeListener = easeAgreeListener;
    }

    public interface EaseAgreeListener {
        void agree();
